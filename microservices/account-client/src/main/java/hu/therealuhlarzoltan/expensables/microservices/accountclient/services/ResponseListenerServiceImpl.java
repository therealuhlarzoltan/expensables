...
public class
ResponseListenerServiceImpl implements ResponseListenerService {
    ...
    public Consumer<Message<HttpResponseEvent>> httpResponseProcessor() {
        return message -> {
            ...
            LOG.info("Processing message created at {}... CorrelationId: {}, Event type: {}", event.getEventCreatedAt(), correlationId, eventType);
