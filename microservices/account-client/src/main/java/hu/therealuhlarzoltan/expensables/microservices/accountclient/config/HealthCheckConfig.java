package hu.therealuhlarzoltan.expensables.microservices.accountclient.config;

import hu.therealuhlarzoltan.expensables.microservices.accountclient.services.HealthCheckService;
...
public class HealthCheckConfig {
    ...
    public ReactiveHealthContributor coreServices() {
        ...
        registry.put("transaction-service", () -> healthService.getTransactionHealth());
